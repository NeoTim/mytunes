...
var PlayerView = Backbone.View.extend({
  ...
  el: '<div class="col-md-8"><blockquote id="player"><p><i class="fa fa-music fa-2x"></i> <strong id="current"></strong></p><audio controls autoplay style="width:100%;"></blockquote></div>',
